...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # ✅ Dossier où collectstatic va copier les fichiers
...
SWAGGER_SETTINGS = {
    # Désactive le login via session (username/password)
    'USE_SESSION_AUTH': False,
    # Définit le schéma “Bearer” pour JWT
